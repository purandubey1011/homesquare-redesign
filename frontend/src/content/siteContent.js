  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          { title: "Home Improvement", body: "Paints, marbles, surfaces, furnishings, interiors and design-led products.", image: "/card-images/brandmix-home.jpg" },
          { title: "Electronics & Lifestyle", body: "Appliances, gadgets and modern home electronics for everyday living.", image: "/card-images/brandmix-electronics.jpg" },
          { title: "Interior & Decor Solutions", body: "Design services, furnishings, finishes and styling support for homes and offices.", image: "/card-images/brandmix-interior.jpg" },
          { title: "Food & Experience", body: "Dining options that make the destination more engaging and encourage visitors to spend more time.", image: "/card-images/brandmix-food.jpg" },
          { title: "Beauty & Lifestyle Services", body: "Supporting services that make the destination more rounded, relevant and convenient.", image: "/card-images/brandmix-beauty.jpg" },
        ],
      },
      {
        type: "cards",
        ...
        items: [
          { title: "Customers benefit", body: "They can discover, compare and complete more of their decision journey in one visit.", image: "/card-images/benefit-customers.jpg" },
          { title: "Brands benefit", body: "They gain stronger adjacency, better context and more meaningful customer flow.", image: "/card-images/benefit-brands.jpg" },
          { title: "The destination benefits", body: "A more relevant mix strengthens repeat visits, trust and premium perception.", image: "/card-images/benefit-destination.jpg" },
        ],
      },
      {
        type: "ctaBanner",
