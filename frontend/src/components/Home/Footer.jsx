import { footerLinks, socialLinks } from "./homeData";

const stayLinks = [
  { label: "Garden Villa", href: "#villas" },
  { label: "Pool Villa", href: "#villas" },
  { label: "Luxury Pool Villa", href: "#villas" },
  { label: "Two Bedroom Pool Villa", href: "#villas" },
];

const discoverLinks = [
  { label: "Secret Waterfalls", href: "#packages" },
  { label: "Dolphins of Lovina", href: "#packages" },
  { label: "Diving and Snorkling", href: "#packages" },
];
...
function Stars() {
  return (
    <span className="text-[1.2rem] tracking-[0.08em] text-[#ef8f16]">
      *****
    </span>
  );
}
...
export default function Footer() {
  return (
    <footer className="border-t border-[rgba(50,32,24,0.12)] bg-[#eae5df]" id="footer">
      <div className="grid grid-cols-1 border-b border-[rgba(50,32,24,0.12)] xl:grid-cols-[1.12fr_1.12fr_1.1fr]">
