...
import { discoverLinks, socialLinks, stayLinks } from "../Discover/discoverData";
import { packageNavLinks } from "./packagesData";
...
export default function PackagesNavbar() {
  ...
  return (
    <>
      <header className="fixed inset-x-0 top-0 z-40 border-b border-[rgba(72,54,42,0.12)] bg-[#eae5df] px-4 md:px-8 xl:px-12">
        <div className="flex h-[106px] w-full items-center justify-between">
          <div className="flex min-w-0 items-center gap-4 xl:gap-6">
            ...
            <nav className="hidden items-center lg:flex" aria-label="Primary">
              {packageNavLinks.map((link) => (
                <a
                  key={link.label}
                  href={link.href}
                  className={`${navLinkClass} ${
                    link.label === "Packages" ? "before:opacity-100" : ""
                  }`}
                >
                  {link.label}
                </a>
        ...
        >
          ...
          <div className="flex min-h-0 flex-1 flex-col">
            ...
            <div className="mt-auto border-t border-[rgba(50,32,24,0.1)] pt-8">
              ...
              <div className="mt-8 flex flex-wrap items-center gap-6 text-[0.9rem] text-[rgba(76,58,46,0.58)]">
